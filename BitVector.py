...
__date__    = '2019-March-31'
__url__     = 'https://engineering.purdue.edu/kak/dist/BitVector-3.4.9.html'
__copyright__ = "(C) 2019 Avinash Kak. Python Software Foundation."
...
class BitVector( object ):                                           
    ...
    def __add__(self, other):                                       
        ...
        if isinstance(self.vector, array.array):
            # This is a workaround to avoid having to import deepcopy
